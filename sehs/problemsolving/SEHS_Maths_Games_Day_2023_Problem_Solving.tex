...
Hint: Represent the 4-digit number as $ABCD$. 
    \question
\begin{parts}
\part  Suppose you have an analogue clock with an hour hand and a minute hand. If it is currently midnight, at what time will the two hands form a right angle? Give your answer to the nearest second, in the form HH:MM:SS. 
\part How many times will the hour and minute hand form a right-angle over the course of 24 hours?
\end{parts}
    ...
    \[  \includegraphics[scale=0.3]{how-many-triangles-do-you-see-1.png}\]
      ...
      \question 
      \begin{parts}
         \part Find the smallest integer \(x\) such that \(480x\) is a perfect square. 
...
\question
\begin{parts}
\part Prove that there is no smallest positive number.
\part Explain why there is no biggest number.
\end{parts}
